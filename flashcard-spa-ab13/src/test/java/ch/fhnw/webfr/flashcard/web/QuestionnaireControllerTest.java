...
public class QuestionnaireControllerTest {
    ...
    public void findAll_QuestionnairesFound_ShouldReturnFoundQuestionnaires() throws Exception {
		Questionnaire questionnaire1 = new QuestionnaireBuilder(1L)
				.description("MyDescription1")
				.title("MyTitle1")
				.build();
		
		Questionnaire questionnaire2 = new QuestionnaireBuilder(2L)
	...
	public void update_questionnaire_ShouldReturnOK() throws Exception {
		Questionnaire updatedQuestionnaire = new QuestionnaireBuilder(1L)
			.description("MyDescription")
			.title("MyTitle")
			.build();		
